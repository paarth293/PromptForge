...
import { ArrowLeft, Dna, Sparkles, Cpu } from 'lucide-react';
import DeepForgeLineageViewer from '../../components/DeepForgeLineageViewer';

export default function EvolvePage() {
  return (
    <main className="min-h-screen bg-forge-dark text-slate-100 font-sans selection:bg-purple-600 selection:text-white">
      ...
      <header className="w-full border-b border-forge-border bg-forge-dark/90 backdrop-blur-md sticky top-0 z-50 px-4 md:px-8 py-3 flex items-center gap-4">
        ...
        <span className="hidden sm:inline text-xs text-slate-400">Evolutionary Multi-Generation Prompt Engine</span>
